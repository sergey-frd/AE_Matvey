...
function main() 
{
   ...
   // AAAAAAAAAAAAAAAAAAAAAAAAAAAA
    genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_Matvey\\xml\\gen_System_22_s5m3.xml");
    ...
    var compFinalName = "aeFinalMatvey23mr3";
    finalComp = handleFinalCompAll(compFinalName);

    var compFinalName = "aeFinalMatvey23mr3_ph_a_bg_1";
    finalComp = handleFinalCompAll_Bg(compFinalName);

    var compFinalName = "aeFinalMatvey23mr3_bg_1";
